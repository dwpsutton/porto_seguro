'''
    This pipe is the original pipe1 from wp015.
    '''
...
def add_gp_feats(df):
    ...
    df.loc[:,"v1"] = 0.020000*np.tanh((df["loo_ps_ind_06_bin"] + (df["ps_reg_01"] + (df["ps_car_12"] + (df["loo_ps_car_03_cat"] + df["loo_ps_car_07_cat"])))))
    df.loc[:,"v2"] = 0.020000*np.tanh((df["loo_ps_ind_17_bin"] + ((df["ps_reg_03"] + df["ps_car_12"]) + (df["loo_ps_ind_06_bin"] + df["loo_ps_ind_05_cat"]))))
    df.loc[:,"v3"] = 0.020000*np.tanh((df["loo_ps_car_01_cat"] + (df["loo_ps_ind_17_bin"] + ((df["ps_car_12"] + df["ps_reg_03"]) + df["loo_ps_ind_07_bin"]))))
    df.loc[:,"v4"] = 0.020000*np.tanh((df["loo_ps_car_01_cat"] + ((df["loo_ps_car_04_cat"] + (df["ps_reg_03"] + df["ps_car_15"])) * 3.0)))
    df.loc[:,"v5"] = 0.020000*np.tanh(((df["ps_car_13"] + ((df["loo_ps_car_05_cat"] + (df["ps_reg_01"] + df["loo_ps_car_09_cat"]))/2.0)) * (10.28825187683105469)))
    df.loc[:,"v6"] = 0.020000*np.tanh(((8.0) * (df["loo_ps_car_04_cat"] + ((df["loo_ps_car_01_cat"] + df["loo_ps_ind_05_cat"]) + df["ps_car_15"]))))
    df.loc[:,"v7"] = 0.020000*np.tanh(((df["ps_car_13"] + (((df["loo_ps_car_01_cat"] + df["ps_reg_03"]) + df["loo_ps_ind_16_bin"])/2.0)) * 8.428570))
    df.loc[:,"v8"] = 0.020000*np.tanh(((10.86397266387939453) * (((df["ps_reg_03"] + df["loo_ps_car_07_cat"]) + df["loo_ps_ind_06_bin"]) + df["loo_ps_car_11_cat"])))
    df.loc[:,"v9"] = 0.020000*np.tanh((df["ps_reg_03"] + (df["loo_ps_ind_16_bin"] + (df["loo_ps_ind_07_bin"] + (df["ps_car_13"] + df["loo_ps_car_03_cat"])))))
    df.loc[:,"v10"] = 0.020000*np.tanh((((df["ps_car_13"] + df["ps_reg_02"]) - df["ps_ind_15"]) + (df["loo_ps_car_11_cat"] + df["loo_ps_ind_17_bin"])))


def run_pipe4(train_df,test_df):
...
def test():
    ...
    return run_pipe4(trn_df,sub_df)
