...
def run_pipe2(trn_df,sub_df):
    ...
    if "target" in sub_df.columns:
        target_sub= sub_df["target"].as_matrix()
    else:
        target_sub= None
...
#        print '\r' * 75
    ...
    return trn_df.as_matrix(), target.as_matrix(), sub_df.as_matrix(),target_sub
...
def test():
    ...
    return run_pipe2(trn_df,sub_df)
